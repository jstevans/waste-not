...
export type Graph = {
    forward: FileInfo<Dependencies & { dependencies: Dependencies['fileDependencies'] }>,
    reverseFiles: FileInfo<string[]>,
    reverseWildcards: FileInfo<string>
}

export default function buildDependencyGraph(filePaths: string[], getDependencies: DependencyGetter): Graph {
